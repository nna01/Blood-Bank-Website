...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="auto-style8">
        <strong>
        <asp:Label ID="Label1" runat="server" CssClass="auto-style9" Text="O positive(+) Blood Donors List" Width="100%" style="font-size: x-large; color: #800000; text-decoration: underline; background-color: #FFFF99"></asp:Label>
        </strong>
    </p>
